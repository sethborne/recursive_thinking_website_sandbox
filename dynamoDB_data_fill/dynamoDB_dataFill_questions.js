...
function buildJSONStringForLessonOutput(questionArray, questionTable){
    ...
    for(let i = 0; i < questionArray.length; i += 1){
        ...
        for(let i = 0; i < loopTimes; i += 1){
          ...
          //need to remove the value of the skill we are 
    ...
    fs.writeFileSync(`../../recursive_thinking_website_react_sandbox/recursive_thinking_website_react/data_returns/${questionTable}.json`, questionObj, 'utf8')
